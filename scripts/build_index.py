...
<section id="s86">
  ...
  <div class="callout warn" style="margin:10px 0;">
    ...
    <strong>複数ショック共通の普遍核は NGAS / COPPER / CHINA50 (コモディティ・中国景気サイクル) だった</strong>。
  ...
  <div class="callout found" style="margin-top:24px;">
    ...
    さらに 4 ショックで再現すると (解剖 8)、共通の普遍核は
    <strong>NGAS・COPPER・CHINA50 (コモディティ・中国景気サイクル)</strong> で、
...
<section id="s11">
  ...
  <table>
    ...
    <tr><td><strong>銘柄構成バリエーション総当たり</strong></td>
        ...
        <td>20-30 銘柄で頑健。4 ショック LOO で普遍核は NGAS/COPPER/CHINA50、周辺はイベント依存の二層構造 (<code>scripts/loo_multi_shock.py</code>)</td></tr>

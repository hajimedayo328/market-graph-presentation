...
<section id="s5">
  ...
  <div class="callout found">
    <h4>結論: 独立性は設定非依存</h4>
    <p>全 10 設定で <strong>|r| &lt; 0.5</strong>、うち 9/10 は <strong>|r| &lt; 0.3</strong>
    (範囲 0.05〜0.41、平均 0.17)。window を 20〜60 日、threshold を 0.2〜0.4、市場を米国・新興国・中国と
    変えても 2 指標は独立に動き続ける。<strong>独立性は特定パラメータ選択の「まぐれ」ではなく、
    設定に対して頑健な性質</strong>と確認できた。</p>
  </div>
</section>

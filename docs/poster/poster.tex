...
\vspace{1mm}
\centering
\includegraphics[width=\linewidth]{../../figs/slide_independence.png}

\vspace{1mm}
\raggedright
\begin{itemize}
\setlength{\itemsep}{1mm}
\item \textbf{短期（5年）}：2指標はばらばらに動き\textbf{\color{accent}独立}（別々の情報を持つ）
\item \textbf{長期（20年）}：危機（2008・2020等）を多く含み、両指標が同時に跳ねて\textbf{\color{warn}相関が上がる}
\end{itemize}
}
...
\]
{\color{muted}\small mean・sd＝その日\textbf{まで}の平均・標準偏差（未来は見ない）。}

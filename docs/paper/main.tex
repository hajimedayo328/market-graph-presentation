...
complement rather than a pure return-enhancement strategy. The work bridges three previously separate research lines:
...
$S_1$: $e_{\mathrm{div}} \geq 0.8$ (short) & $+57.9\%$ & $+9.5\%$ & $\mathbf{+0.88}$ & $\mathbf{-17.3\%}$ & $16.5$ \\
$S_2$: $e_{\mathrm{div}} \leq -0.5$ (long) & $+53.5\%$ & $+8.9\%$ & $+0.70$ & $-20.9\%$ & $17.1$ \\
$S_6$: $z_{L^1} \wedge z_{\text{unb}}$ (short) & $+76.5\%$ & $+12.0\%$ & $+0.76$ & $-22.8\%$ & $9.0$ \\
\bottomrule
\end{tabular}
\end{table}
